	...
	b["true"] = a,
		...
		window.rangy = function() {
			...
			function d(a, b, c) {
				...
				if (d)
					for (var e = 0, f = d.length; f > e; ++e) d[e].call(a, {
						target: a,
						args: c
					})
			}
			...
			function G(c, d, g) {
				...
				c.prototype = new C, a.util.extend(c.prototype, {
					...
					normalizeBoundaries: function() {
						...
						var a = this.startContainer,
							...
							g = function(d) {
								...
								if (f && f.nodeType == d.nodeType) {
									a = d;
									var g = d.length;
									if (b = f.length, d.insertData(0, f.data), f.parentNode.removeChild(f), a == c) e += b, c = a;
							...
							h = !0;
						if (L.isCharacterDataNode(c)) c.length == e && f(c);
						else {
							if (e > 0) {
						...
						if (h) {
							if (L.isCharacterDataNode(a)) 0 == b && g(a);
			...
			C.prototype = {
				...
				compareBoundaryPoints: function(a, b) {
					...
					var c, d, e, f, g = a == db || a == ab ? "start" : "end",
						h = a == bb || a == ab ? "start" : "end";
			...
			function d(a, b, c, d) {
				...
				var i, j, k, l, m, n = g.getDocument(f).createElement("span"),
					o = c ? "StartToStart" : "StartToEnd";
			...
			function e(a, b) {
				var c, d, e, f, h = a.offset,
					i = g.getDocument(a.node),
					j = i.body.createTextRange(),
					k = g.isCharacterDataNode(a.node);
			...
			function i(a) {
				...
				for (var b = 1, c = a.length; c > b; ++b)
					if (!w.isAncestorOf(a[0], a[b])) return !1;
				return !0
			}
			...
			function m(b) {
				if (b._ranges.length = 0, "None" == b.docSelection.type) g(b);
				else {
			...
			function r(a) {
				...
				if ("undefined" != typeof a.rangeCount)
					for (var f = 0, g = a.rangeCount; g > f; ++f) b[f] = y.inspect(a.getRangeAt(f));
			...
			var s, t, u = "boolean",
				...
				B = w.DomPosition,
				C = "Control",
				D = a.util.isHostMethod(window, "getSelection"),
				E = a.util.isHostObject(document, "selection"),
				F = E && (!D || a.config.preferTextRange);
			...
			if (!F && J && x.areHostMethods(G, ["removeAllRanges", "addRange"])) {
				...
				R.addRange = L ? function(b, c) {
					if (P && E && this.docSelection.type == C) n(this, b);
					else if (c && K) S(this, b);
					else {
						var d;
				...
				R.removeAllRanges = function() {
					try {
						if (this.docSelection.empty(), "None" != this.docSelection.type) {
							var a;
							if (this.anchorNode) a = w.getDocument(this.anchorNode);
			...
			if (F) T = function(b) {
				...
				if (P && E && b.docSelection.type == C) m(b);
			...
			R.refresh = function(a) {
				...
				if (T(this), a) {
					...
					for (; c--;)
						if (!y.rangesEqual(b[c], this._ranges[c])) return !1;
					return !0
				}
			};
			var U = function(a, b) {
		...
		rangy.createModule("SaveRestore", function(a, b) {
			...
			function d(a, b) {
				var c, d = "selectionBoundary_" + +new Date + "_" + ("" + Math.random()).slice(2),
					e = k.getDocument(a.startContainer),
					f = a.cloneRange();
